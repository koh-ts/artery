...
try:
    ...
    res = subprocess.getoutput("$SUMO_HOME/tools/randomTrips.py --validate --min-distance=" + str(min_distance) + " -n " + map_name + ".net.xml --flow=" + str(route_num) + " --route-file=" + map_name + "_un_fixed.rou.xml")
    print(res)
except:
    print("Error.")
